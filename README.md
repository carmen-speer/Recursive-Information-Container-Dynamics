...
[`docs/manuscript/RICD_12_9_master.docx`](docs/manuscript/RICD_12_9_master.docx)
(also available as [`.tex`](docs/manuscript/RICD_12_9_master.tex)).**
...
[Integration Manifest](reports/RICD_Integration_Manifest_Complete.docx) records
...
sector as a whole), [`Carmens_Role_5.docx`](reports/Carmens_Role_5.docx) (a
record of Carmen Speer's role in building the framework and the tracker —
including the actual division of labor between Carmen and her AI drafting
collaborator, stated directly), [`RICD_Adapter_Instructional_Manual.docx`](reports/RICD_Adapter_Instructional_Manual.docx) (an instructional manual for
...
complete [`RICD_Integration_Manifest_Complete.docx`](reports/RICD_Integration_Manifest_Complete.docx) described above. An
interlinear **Source Translation Ledger**
([`source-documents/Source_Translation_Ledger new.pdf`](source-documents/Source_Translation_Ledger%20new.pdf))
...
docs/manuscript/
  RICD_12_9_master.docx, .tex    The full, domain-independent RICD theory
source-documents/
...
reports/
  ...
  Carmens_Role_5.docx                     Carmen Speer's role in building RICD and the tracker
...
source-documents/
  Source_Translation_Ledger new.pdf        The four source poems set directly alongside RICD's own mathematics, line by line
results/
