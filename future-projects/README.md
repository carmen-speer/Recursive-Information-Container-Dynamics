...
This folder holds work that is proposed, seeded, or theorized but not yet
built, funded, or validated — kept visible here rather than folded into the
validated tracker above, so the real state of each idea is checkable rather
than asserted.

## Contents

- [`Next Project for RICD - Four Adapter Build Roadmap.pdf`](<Next Project for RICD - Four Adapter Build Roadmap.pdf>) —
  ...
  application, prepared for grant application documentation. The revenue
  from these four adapters is intended to fund Plurimo (below) without
  seeking Plurimo's own, much larger, funding directly.
- [`RICD Ongoing Projects Roadmap.pdf`](<RICD Ongoing Projects Roadmap.pdf>) —
...
- [`Web–Field Model of Cognitive Trait Distributions and Social Evolution.pdf`](<Web–Field Model of Cognitive Trait Distributions and Social Evolution.pdf>) —
  ...
  discrete types, and deriving from it a proposed learning-style metric,
